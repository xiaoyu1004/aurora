...
void cpu::decode() {
    ...
    decode_info_.imm_i = static_cast<int32_t>(inst_) >> 20;
    decode_info_.imm_s =
        (static_cast<int32_t>(inst_) >> 25 << 5) | ((static_cast<int32_t>(inst_) >> 7) & 0b11111);
    decode_info_.imm_b = (static_cast<int32_t>(inst_) >> 31 << 11) |
                         (static_cast<int32_t>(inst_) >> 7 & 0b1 << 10) |
                         (static_cast<int32_t>(inst_) >> 25 & 0b111111 << 4) |
                         (static_cast<int32_t>(inst_) >> 8 & 0xFF);
    decode_info_.imm_u = static_cast<int32_t>(inst_) >> 12;
    decode_info_.imm_j =
        (static_cast<int32_t>(inst_) >> 31) | (static_cast<int32_t>(inst_) >> 12 & 0xFF) |
        (static_cast<int32_t>(inst_) >> 20 & 0b1) | (static_cast<int32_t>(inst_) >> 21 & 0x3FF);
